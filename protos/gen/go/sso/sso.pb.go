...
type LoginResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         int64                  `protobuf:"varint,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token of the logged in user.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\aisAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x19Z\x17kolesnikov.sso.v1;ssoy1b\x06proto3"
